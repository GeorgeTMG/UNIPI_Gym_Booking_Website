            ...
            <main>
                <div id="carouse-caps" className="carousel slide" data-bs-ride="carousel">
                    ...
                    <div className="carousel-inner">
                        ...
                        <div className="carousel-caption d-none d-md-flex h-100 align-items-center justify-content-center">
                            <div className="d-flex flex-column text-center">
                                <h1 className="display-1 fw-bold">First slide label</h1>
                                <p className="mt-1">Some representative placeholder content for the first slide.</p>
                            </div>
                        </div>
                        </div>
                        ...
                        <div className="carousel-caption d-none d-md-flex h-100 align-items-center justify-content-center">
                            <div className="d-flex flex-column text-center">
                                ...
                                <p className="mt-1">Some representative placeholder content for the second slide.</p>
                            </div>
                        </div>
                        </div>
                        <div className="carousel-item c-item">
                        ...
                        <div className="carousel-caption d-none d-md-flex h-100 align-items-center justify-content-center">
                            <div className="d-flex flex-column text-center">
                                ...
                                <p className="mt-1">Some representative placeholder content for the third slide.</p>
                            </div>
                        </div>
                        </div>
                    </div>
