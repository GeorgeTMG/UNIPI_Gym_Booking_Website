...
function Home() {
    return (
        <>
            <Navigation/>
            <main>
                <div id="carouse-caps" class="carousel slide" data-bs-ride="carousel">
                    <div class="carousel-indicators">
                        <button type="button" data-bs-target="#carouse-caps" data-bs-slide-to="0" class="active" aria-current="true" aria-label="Slide 1"></button>
                    ...
                    <div class="carousel-inner">
                        ...
                        <div class="carousel-caption d-none top-0 d-md-block car-cap">
                            <h1 class="display-1 fw-bold">First slide label</h1>
                            <p class="mt-4">Some representative placeholder content for the first slide.</p>
                        </div>
                        </div>
                        <div class="carousel-item c-item">
                        <img src="https://external-content.duckduckgo.com/iu/?u=https%3A%2F%2Fimages.pexels.com%2Fphotos%2F841130%2Fpexels-photo-841130.jpeg%3Fcs%3Dsrgb%26dl%3Daction-athlete-barbell-841130.jpg%26fm%3Djpg&f=1&nofb=1&ipt=bf020548dea3a1892bd865af0484243b20f0779b763c4b8a115626576d2dbf1b" class="d-block w-100 c-image" alt="..."/>
                        <div class="carousel-caption d-none top-0 d-md-block car-cap">
                            <h1 class="display-1 fw-bold">Second slide label</h1>
                            <p class="mt-4">Some representative placeholder content for the second slide.</p>
                        </div>
                        </div>
                        <div class="carousel-item c-item">
                        ...
                        <div class="carousel-caption d-none top-0 d-md-block car-cap">
                            ...
                            <p class="mt-4">Some representative placeholder content for the third slide.</p>
                        </div>
                        </div>
                    </div>
                    <button class="carousel-control-prev" type="button" data-bs-target="#carouse-caps" data-bs-slide="prev">
                        <span class="carousel-control-prev-icon" aria-hidden="true"></span>
                        <span class="visually-hidden">Previous</span>
                    </button>
                    <button class="carousel-control-next" type="button" data-bs-target="#carouse-caps" data-bs-slide="next">
